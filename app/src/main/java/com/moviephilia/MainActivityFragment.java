...
import com.moviephilia.Adapter.mListAdapter;
import com.moviephilia.Admob.Admob;
...
public class MainActivityFragment extends Fragment {
   ...
   @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        admob =Admob.getInstance(getActivity(),getResources().getString(R.string.YOUR_ADMOB_Test_APP_ID));

        //banner unit id already set on xml layout
        admob.showAdmobBannerLoad(adView);
